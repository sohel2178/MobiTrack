...
public class MyPostVolley {
    ...
    public MyPostVolley(Context context, Map<String,String> params, String url,VolleyPostListener listener){
        this.params = params;
        this.url =url;
        this.listener = listener;


        applyForService(context);
    }
    ...
    private void applyForService(Context context){
